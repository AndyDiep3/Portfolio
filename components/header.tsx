...
export default function Header() {
  ...
  return (
    <header className="z-[999] relative">
      ...
      bg-opcacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem]
      ...
      ></motion.div>
      <nav
        className="flex fixed top-[0.10rem] left-1/2 h-12 -translate-x-1/2
      py-2 sm:top-[2rem] sm:h-[initial] sm:py-0"
      >
        <ul
          className="flex w-[22rem] flex-wrap
        items-cneter justify-center gap-y-1 text-[0.9rem]
