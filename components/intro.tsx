...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Andy.</span> I'm a{" "}
        <span className="font-bold">software developer</span> with{" "}
        <span className="font-bold">2 years</span> of experience. I enjoy
        building <span className="italic">sites & apps</span>. My focus is{" "}
        <span className="underline">React (React.js & Next.js)</span>.
      </motion.h1>

      {/* Intro Buttons */}
      <motion.div
        className="flex flec-col sm:flex-row
      items-center justify-center gap-3 px-4
      text-lg font-medium"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
      ...
      >
        ...
        {/* Download */}
        <a
          className="group bg-white px-6 py-3 flex 
          items-center gap-2 rounded-full
          outline-none focus:scale-110 
          hover:scale-110 active:scale-105 
          transition cursor-pointer border
          borderBlack dark:bg-white/10"
          href="/Andy Diep - Resume.pdf"
          download
        >
          Download Resume{" "}
          <HiDownload
            className="opacicty-60 group-hover:translate-y-1 
          transition"
          />
        </a>
        ...
        hover:text-gray-950 active:scale-105 
          ...
          borderBlack dark:bg-white/10
           dark:text-white/60"
          href="https://www.linkedin.com/in/andy-diep-521472182"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        hover:text-gray-950 active:scale-105 
          ...
          borderBlack dark:bg-white/10
           dark:text-white/60"
          href="https://github.com/AndyDiep93"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
